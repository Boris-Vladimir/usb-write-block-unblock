...
# python 3.4
buildOptions = dict(include_files = ['tcl86t.dll', 'tk86t.dll'])

setup(  name = "USB Write Blocker",
        version = "1.0",
        description = "Blocker Unblocker for USB Writing",
        author = "Nuno Venâncio",
        options = dict(build_exe = buildOptions),
        executables = [Executable("USB_Write_Blocker.py", base=base, icon="tray.ico")])
